...
var Formik = (function (_super) {
    ...
    function Formik(props) {
        ...
        _this.runValidationSchema = function (values, onSuccess) {
            var _a = _this.props, validationSchema = _a.validationSchema, validationSchemaContext = _a.validationSchemaContext;
            var schema = isFunction$1(validationSchema)
                ? validationSchema()
                : validationSchema;
            var context = isFunction$1(validationSchemaContext)
                ? validationSchemaContext(values)
                : validationSchemaContext;
            validateYupSchema(values, schema, false, context).then(function () {
    ...
    Formik.prototype.getChildContext = function () {
        return {
            formik: __assign({}, this.getFormikBag(), { validationSchema: this.props.validationSchema, validationSchemaContext: this.props.validationSchemaContext, validate: this.props.validate }),
        };
    };
    ...
    Formik.propTypes = {
        ...
        validationSchemaContext: index_2([
            index_5,
            index_1,
        ]),
        validate: index_5,
...
var Field = (function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        if (typeof component === 'string') {
            return React.createElement(component, __assign({}, field, props, { children: children }));
        }
...
var Form = function (props, context) { return (React.createElement("form", __assign({ onSubmit: context.formik.handleSubmit }, props))); };
Form.contextTypes = {
    formik: index_1,
};
    ...
    return function createFormik(Component) {
        var C = (function (_super) {
            ...
            function C() {
                ...
                _this.validationSchemaContext = function (values) {
                    return isFunction$1(config.validationSchemaContext)
                        ? config.validationSchemaContext(values, _this.props)
            ...
            C.prototype.render = function () {
                return (React.createElement(Formik, __assign({}, this.props, config, { validate: config.validate && this.validate, validationSchema: config.validationSchema && this.validationSchema, validationSchemaContext: config.validationSchemaContext && this.validationSchemaContext, initialValues: mapPropsToValues(this.props), onSubmit: this.handleSubmit, render: this.renderFormComponent })));
            };
            return C;
        }(React.Component));
        return index$7(C, Component);
    };
}
...
function isEqualExceptForKey(a, b, path) {
    return index$4(setIn(a, path, undefined), setIn(b, path, undefined));
}
var FastField = (function (_super) {
    __extends(FastField, _super);
    function FastField(props, context) {
        var _this = _super.call(this, props) || this;
        _this.handleChange = function (e) {
            e.persist();
            var _a = _this.context.formik, validateOnChange = _a.validateOnChange, validate = _a.validate, values = _a.values, validationSchema = _a.validationSchema, validationSchemaContext = _a.validationSchemaContext, errors = _a.errors, setFormikState = _a.setFormikState;
                ...
                if (_this.props.validate) {
                    ...
                    try {
                        ...
                        if (e.name === 'ValidationError') {
                            ...
                            validateYupSchema(mergedValues, schema, false, context).then(function () { return _this.setState({ error: undefined }); }, function (err) {
    ...
    FastField.prototype.componentWillReceiveProps = function (nextProps, nextContext) {
        ...
        if (nextFieldError !== this.state.error) {
            nextState = __assign({}, nextState, { error: nextFieldError });
        }
        if (nextState) {
            this.setState(function (s) { return (__assign({}, s, nextState)); });
        }
    };
    ...
    FastField.prototype.componentWillMount = function () {
        var _a = this.props, render = _a.render, children = _a.children, component = _a.component;
        warning_1$2(!(component && render), 'You should not use <FastField component> and <FastField render> in the same <FastField> component; <FastField component> will be ignored');
        warning_1$2(!(this.props.component && children && isFunction$1(children)), 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.');
        warning_1$2(!(render && children && !isEmptyChildren(children)), 'You should not use <FastField render> and <FastField children> in the same <FastField> component; <FastField children> will be ignored');
    };
